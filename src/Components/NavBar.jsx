...
function NavBar() {
    ...
    return (
        <div className=' flxed w-full h-[80px] gap-70 flex justify-between  items-center px-4 bg-[#0a192f] text-gray-300 sticky top-0 z-50 drop-shadow-lg shadow-blue-600'>
            <div >
